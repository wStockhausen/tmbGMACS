#--script to test probGrw functions
#----see inst/include/tmb/ProbGrowthFunctions.hpp
#
...
#--compile probGrowthFunctions.cpp as a module "probgrwfcns_module"
require(Rcpp)
#require(RcppEigen)
require(TMB)
sourceCpp(file="probGrowthFunctions.cpp",
...
pPrGr1 = c(pGr1,1);
cPrGr1 = c();
res = probGrw1(zBs,zCs,pPrGr1,cPrGr1);
